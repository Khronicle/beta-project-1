...
const Footer: React.FC<FooterProps> = ({
    companyName = 'Beta Hub',
    year = new Date().getFullYear()
}) => {
    return (
        <footer className="bg-slate-900 text-gray-300 py-12 px-4 mt-16 border-t border-gray-700">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#team" className="hover:text-teal-400 transition-colors">Team</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#api" className="hover:text-teal-400 transition-colors">API</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            <a
                                href="#twitter"
                                aria-label="Twitter"
                                className="px-3 py-1.5 bg-teal-500 bg-opacity-10 rounded hover:bg-teal-400 hover:text-slate-900 transition-all"
                            >
                                Twitter
                            </a>
                            <a
